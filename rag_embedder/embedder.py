...
class Embedder:
    def __init__(self, embedding_model: str = "all-MiniLM-l6-v2", verbose: bool = True) -> None:
        ...
        try:
            ...
            self.verboseprint(f"EMBEDDER: Embedder initialized successfully with configuration: embedding_model = {self.model_name}")
        except Exception as e:
            self.verboseprint(f"EMBEDDER: Embedder initialization failed. Error: {str(e)}")
